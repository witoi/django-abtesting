...
def experiments_overview(request):
    ...
    return render_to_response("abtesting/experiments_overview.html",
                              {"title": "Experiments",
                               "exps": exps},
...
def experiment_detail(request, expname):
    ...
    return render_to_response("abtesting/experiment_detail.html",
                              {"title": exp.name,
                               "exp": exp,
                               "repts": repts
                               },
...
def experiment_report(request, expname, report_id):
    ...
    return render_to_response("abtesting/experiment_report.html",
                              {"title": rept.title,
                               "exp": rept.experiment,
                               "rept": rept,
...
def experiment_log(request, expname, variant, goal):
    ...
    return render_to_response("abtesting/experiment_log.html",
                              {"exp": exp,
